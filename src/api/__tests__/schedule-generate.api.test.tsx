...
describe('useGenerateHybridForWeekMutation', () => {
  it('POST /schedules/generate/hybrid con weekStart parametrizable', async () => {
    let body: unknown;
    server.use(
      http.post(`${API_URL}/schedules/generate/hybrid`, async ({ request }) => {
    ...
    result.current.mutate({ weekStart: '2026-04-27', maxFairnessDeviation: 1 });
